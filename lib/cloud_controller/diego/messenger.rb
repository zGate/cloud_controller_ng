module VCAP::CloudController
  module Diego
    class Messenger
      ...
      def send_stage_request(app, staging_timeout, minimum_staging_memory)
        logger.info('staging.begin', app_guid: app.guid)
        @message_bus.publish(*@protocol.stage_app_request(app, staging_timeout, minimum_staging_memory))
      end
